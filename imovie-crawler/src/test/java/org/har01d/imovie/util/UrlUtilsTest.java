...
public class UrlUtilsTest {
    ...
    public void testFindED2K() throws Exception {
        assertNull(UrlUtils.findED2K("感谢楼主分享！！！"));
        assertNull(UrlUtils.findED2K("magnet:?xt=urn:btih:FF259A586E61FA2233277DECB5FA508293CDB626"));
        assertNull(
        ...
        assertEquals(ed2k, UrlUtils.findED2K(ed2k));
    ...
    public void testFindMagnet() throws Exception {
        assertNull(UrlUtils.findMagnet("感谢楼主分享！！！"));
        assertNull(UrlUtils.findMagnet("magnet:?xt=urn:btih:&dn=123"));

        String magnet = "magnet:?xt=urn:btih:FF259A586E61FA2233277DECB5FA508293CDB626";
        assertEquals(magnet, UrlUtils.findMagnet(magnet));
