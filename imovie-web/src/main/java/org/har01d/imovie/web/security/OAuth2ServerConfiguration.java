...
public class OAuth2ServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
            ...
            .antMatchers("/api/resources").fullyAuthenticated()
            .antMatchers("/api/favourites/**").fullyAuthenticated()
            ...
            .antMatchers("/api/configs/**", "/api/events/**", "/api/users/**")
            .access("hasRole('ROLE_ADMIN') and isFullyAuthenticated()")
