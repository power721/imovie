<template>
  <div class="vdp-datepicker" :class="wrapperClass">
    <div class="ui icon input" :class="{'input-group' : bootstrapStyling}">
      <input
        ...
        :required="required"
        readonly>
      <i class="close link icon" v-if="clearButton && selectedDate" @click="clearDate()"></i>
    </div>
    ...
    <div :class="[calendarClass, 'vdp-datepicker__calendar']" v-show="showDayView" :style="calendarStyle">
      <header>
                <span
                  @click="previousMonth"
                  class="prev"
                  :class="{ 'disabled' : previousMonthDisabled(pageDate) }">&lt;</span>
        <span @click="showMonthCalendar" :class="!dayViewOnly ? 'up' : ''">{{ currMonthName }} {{ currYear }}
                </span>
        <span
          @click="nextMonth"
          class="next"
          :class="{ 'disabled' : nextMonthDisabled(pageDate) }">&gt;</span>
      </header>
      ...
      <div :class="[calendarClass, 'vdp-datepicker__calendar']" v-show="showMonthView" :style="calendarStyle">
        <header>
                  <span
                    @click="previousYear"
                    class="prev"
                    :class="{ 'disabled' : previousYearDisabled(pageDate) }">&lt;</span>
          <span @click="showYearCalendar" class="up">{{ getPageYear() }}</span>
          <span
            @click="nextYear"
            class="next"
            :class="{ 'disabled' : nextYearDisabled(pageDate) }">&gt;</span>
        </header>
      ...
      <div :class="[calendarClass, 'vdp-datepicker__calendar']" v-show="showYearView" :style="calendarStyle">
        <header>
                  <span @click="previousDecade" class="prev"
                        :class="{ 'disabled' : previousDecadeDisabled(pageDate) }">&lt;</span>
